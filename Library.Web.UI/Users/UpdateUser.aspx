<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUser.aspx.cs" Inherits="Library.Web.UI.Users.UpdateUser" %>
...
<body>
    <form id="UpdateUser" runat="server">
        <!-- navbar =========================================================== -->
        ...
        <div class="container removePaddingLeft lastItem">
            ...
            <div class="col-sm-4">
                <p>Name</p>
                <asp:TextBox ID="boxName" runat="server" CssClass="required"></asp:TextBox>
            ...
            <div class="col-sm-4">
                <p>Last Name</p>
                <asp:TextBox ID="boxLastName" runat="server" CssClass="required"></asp:TextBox>
                <div class="errorContainer"></div>
            </div>

            <div class="col-sm-4">
                <p>DNI</p>
                <asp:TextBox ID="boxDNI" runat="server" CssClass="required"></asp:TextBox>
                <div class="errorContainer"></div>
            </div>
            ...
            <div class="col-sm-4">
                <p>User Name</p>
                <asp:TextBox ID="boxUserName" runat="server" CssClass="required"></asp:TextBox>
                <div class="errorContainer"></div>
            </div>
            ...
            <div class="col-sm-4">
                <p>PassWord</p>
                <asp:TextBox ID="boxPass" runat="server" CssClass="required"></asp:TextBox>
                <div class="errorContainer"></div>
            </div>
            ...
            <div class="col-sm-4">
                <p>SignUpDate</p>
                <asp:TextBox ID="boxSignUp" runat="server" CssClass="required australianDate datePick"></asp:TextBox>
                <div class="errorContainer"></div>
            </div>
        ...
        <div class="container lastItem">
            <asp:Button ID="ButUpdateUser" CssClass="insertButton btn btn-sm btn-success" runat="server" Text="Update" OnClick="ButUpdateUser_Click" />
