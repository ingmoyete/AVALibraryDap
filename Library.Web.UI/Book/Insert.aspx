<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="Library.Web.UI.Book.Insert" %>
...
<body>
    <form id="insertBooks" runat="server">
        ...
        <div class="container removePaddingLeft lastItem">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <%this.boxCopies.Attributes.Add("maxlength", "2"); %>
                    <div class="col-sm-4">
                        <p>Number of copies</p>
                        <asp:TextBox ID="boxCopies" runat="server" CssClass="required digits"></asp:TextBox>
                    ...
                    <div class="col-sm-4">
                        <p>Ibsn</p>
                        <asp:TextBox ID="boxIbsn" runat="server" AutoPostBack="True" OnTextChanged="boxIbsn_TextChanged" MaxLength="5"></asp:TextBox>
                        <asp:Literal ID="literalIbsn" runat="server"></asp:Literal>
        ...
        <div class="container lastItem">
            <asp:Button ID="ButInsert" CssClass="insertButton btn btn-sm btn-warning" runat="server" Text="Insert" OnClick="ButInsert_Click" />
